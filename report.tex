...
\IEEEauthorblockA{TP – Antenne patch microbande\\
CST Studio Suite\\
12 Décembre 2025}}
...
\begin{abstract}
L'objectif de ce travail pratique est de concevoir et d'analyser une antenne patch microbande résonant à 2,1 GHz, destinée à être intégrée dans un smartphone. Le travail suit une démarche complète comprenant le dimensionnement analytique, la modélisation 3D sous CST Studio Suite, la validation par solveurs fréquentiel et temporel, l'optimisation de l'adaptation par ajout de fentes, et enfin l'étude de l'impact de l'intégration dans un boîtier smartphone. Le substrat utilisé est un FR4 ($\varepsilon_r = 4{,}4$, $h = 0{,}8$ mm).
\end{abstract}
